...
public class DatabaseManager {
	 ...
	 * through .ecf files)
	 */
	public static final String OFFICIAL_CAT_DB_FOLDER = "Interpreting_Tool\\database"
			+ System.getProperty("file.separator");
	// public static final String OFFICIAL_CAT_DB_FOLDER = "database" +
	// System.getProperty("file.separator"); //only debugging pourpose
